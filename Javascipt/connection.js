...
const managerForm = document.getElementById('manager');
console.log("managerE:", managerE, "existBtn:", existBtn, "newBtn:", newBtn);
...
if (managerE) {
  managerE.addEventListener('click', () => {
    ...
    managerForm.style.display = 'block'; // מציג את טופס המנהל
  });
}
...
if (existBtn && loginForm) {
  existBtn.onclick = () => {
    ...
    existBtn.style.display = 'none';
    managerE.style.display = 'none';
    loginForm.style.display = 'block'; // מציג את טופס המשתמש
  };
}

// יצירת משתמשים ברירת מחדל אם אין
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const usernameSpan = document.getElementById("usernameOR");
  if (usernameSpan) {
